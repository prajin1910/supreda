...
import { Search, Send, User, MessageCircle, X, Plus, ArrowLeft } from 'lucide-react';
...
const ChatSection: React.FC = () => {
  ...
  const searchUsers = async (query: string) => {
    ...
    try {
      ...
      const filteredResults = response.data.filter((u: UserType) => u.id !== user!.id);
  ...
  const startNewChat = (selectedUser: UserType) => {
    ...
    const existingConversation = conversations.find(conv => conv.id === selectedUser.id);
                          ...
                          <div className="flex items-center">
                            ...
                            <div className="flex-1">
                              <div className="flex items-center">
                                ...
                                <span className={`ml-2 px-2 py-1 text-xs rounded-full ${getRoleBadge(searchUser.role)}`}>
                                  {searchUser.role}
                                </span>
                              </div>
            ...
            conversations.map((conversation) => (
              <button
                ...
                className={`w-full p-4 border-b border-gray-100 hover:bg-gray-50 transition-colors text-left ${
                  activeChat?.id === conversation.id ? 'bg-blue-50 border-r-2 border-blue-500' : ''
                }`}
              >
                <div className="flex items-center">
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        ...
                        <span className={`ml-2 px-2 py-1 text-xs rounded-full ${getRoleBadge(conversation.role)}`}>
                          {conversation.role}
                        </span>
                      </div>
        ...
        {activeChat ? (
              ...
              <div className="flex items-center">
                ...
                <div>
                  <div className="flex items-center">
                    ...
                    <span className={`ml-2 px-2 py-1 text-xs rounded-full ${getRoleBadge(activeChat.role)}`}>
                      {activeChat.role}
                    </span>
                  </div>
          ...
          <div className="flex-1 flex items-center justify-center bg-gray-50">
            <div className="text-center">
              ...
              <h3 className="text-xl font-medium text-gray-900 mb-2">Welcome to SmartEval Chat</h3>

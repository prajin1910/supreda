...
const AssessmentTaking: React.FC<AssessmentTakingProps> = ({ assessment, onComplete, onExit }) => {
  ...
  const submitAssessment = async () => {
    ...
    try {
      ...
      // Don't set isSubmitting to false here if submission was successful
      // as we're navigating away
    }
  };
          ...
          <div className="mb-6">
            ...
            {timeRemaining < 300 && (
              <div className="flex items-center p-3 bg-red-50 border border-red-200 rounded-lg mb-4">
                ...
                <span className="text-red-700 text-sm">Less than 5 minutes remaining!</span>
              </div>
            )}
          </div>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex space-x-3">
              ...
              {timeRemaining <= 60 && timeRemaining > 0 && (
                <div className="flex items-center p-3 bg-red-100 border border-red-300 rounded-lg mb-4">
                  <AlertCircle className="w-5 h-5 text-red-700 mr-2" />
                  <span className="text-red-800 text-sm font-bold">
                    URGENT: Less than 1 minute remaining! Assessment will auto-submit.
                  </span>
                </div>
              )}
            </div>

...
const AIRoadmapSection: React.FC = () => {
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 mb-2">AI Learning Roadmap</h1>
        <p className="text-gray-600">Generate personalized learning paths with advanced AI assistance</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-6 text-center">AI-Powered Roadmap Generator</h2>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <input
                ...
                required
              />
              <p className="text-xs text-gray-500 mt-1">AI will create a comprehensive learning path for this domain</p>
            </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-3 gap-3">
                {[
                  { value: 'EASY', label: 'Easy', icon: BookOpen, color: 'bg-green-100 text-green-700 border-green-300' },
                  { value: 'MEDIUM', label: 'Medium', icon: Target, color: 'bg-yellow-100 text-yellow-700 border-yellow-300' },
                  { value: 'HARD', label: 'Hard', icon: Zap, color: 'bg-red-100 text-red-700 border-red-300' },
                ].map((option) => (
                  <button
                    key={option.value}
                    type="button"
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-900 mb-6 flex items-center">
            ...
            {showRoadmap ? 'Your AI-Generated Learning Path' : 'AI Learning Path Generator'}
          </h2>
          ...
          {showRoadmap && (
            <div className="bg-blue-50 rounded-lg p-4 mb-6">
              ...
              <p className="text-blue-700 text-sm">
                AI has analyzed your requirements and created a personalized learning path for {formData.domain} 
                at {formData.difficulty.toLowerCase()} level to be completed in {formData.timeframe}.
              </p>
            </div>
          )}
          ...
          {roadmap.length > 0 ? (
                ...
                <div key={index} className="flex items-start group hover:bg-gray-50 p-3 rounded-lg transition-colors">
                  ...
                  <div className="flex-1">
                    ...
                    <div className="mt-2 flex items-center text-xs text-gray-500">
                      ...
                      <span>Step {index + 1} of {roadmap.length}</span>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="text-center py-12">
              ...
              <p className="text-gray-500">Fill out the form to generate your personalized AI roadmap</p>

      ...
      <div className="mb-4">
        {getStatusText(assessment) === 'Upcoming' && (
          <div className="text-sm text-blue-600 bg-blue-50 p-2 rounded">
            Starts in: {getTimeUntilStart(assessment)}
          </div>
        )}
        {getStatusText(assessment) === 'Ongoing' && (
          <div className="text-sm text-green-600 bg-green-50 p-2 rounded">
            {getTimeRemaining(assessment)}
          </div>
        )}
        {hasSubmittedAssessment(assessment.id) && (
          <div className="text-sm text-purple-600 bg-purple-50 p-2 rounded">
            ✓ Submitted - Score: {assessmentResults[assessment.id].score}/{assessment.questions.length}
          </div>
        )}
      </div>
      ...
      <div className="flex justify-between items-center">
        ...
        {getStatusText(assessment) === 'Upcoming' && (
          <span className="text-blue-600 text-sm font-medium">
            Available in {getTimeUntilStart(assessment)}
          </span>
        )}
